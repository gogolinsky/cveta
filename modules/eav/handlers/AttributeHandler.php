...
{
    const VALUE_HANDLER_CLASS = '\app\modules\eav\handlers\RawValueHandler';
    /** @var EavModel */
    public $owner;
    /** @var ValueHandler */
    public $valueHandler;
    ...
    {
        if (!class_exists($class = $attributeModel->eavType->handler_class))
        {
