    ...
    'columns' => [
        ...
        [
            ...
            'value' => function (Service $service) {
                return
                    Html::a('<span class="glyphicon glyphicon-arrow-up"></span>', ['move-up', 'id' => $service->id], [
                        'class' => 'pjax-action'
                    ]) .
                    Html::a('<span class="glyphicon glyphicon-arrow-down"></span>', ['move-down', 'id' => $service->id], [
                        'class' => 'pjax-action'
                    ]);
            },
            'format' => 'raw',
        ...
        [
            ...
            'label' => false,
            'value' => function (Service $service) {
                return $service->getThumbFileUrl('image');
            }
        ],
        [
            'class' => DataColumn::class,
